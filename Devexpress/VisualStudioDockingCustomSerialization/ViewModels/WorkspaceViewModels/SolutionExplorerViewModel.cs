...
public class Solution : BindableBase
{
    ...
    protected Solution()
    {
        ...
        foreach (SolutionItem file in files) { root.Items.Add(file); }
    ...
    public static Solution Create() { return ViewModelSource.Create(() => new Solution()); }
...
{
    public SolutionItemOpeningEventArgs(SolutionItem solutionItem) { SolutionItem = solutionItem; }
