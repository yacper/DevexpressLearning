...
namespace ConditionalFormatting
{
	...
	{
		public SaleOverviewData(string state, double sales, double salesVsTarget, double profit,
								double customersSatisfaction, double markerShare)
		{
			this.State = state;
			this.Sales = sales;
			this.Profit = profit;
		...
		[Display(Name = "Cust Satisfaction")] public double CustomersSatisfaction { get; set; }
	}
}